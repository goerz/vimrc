...
if version >= 508 || !exists("did_html_syn_inits")
  ...
  if !exists("html_no_rendering")
    ...
    if !exists("html_my_rendering")
      ...
      hi def htmlBoldUnderlin         term=none  cterm=none  gui=none
      hi def htmlBoldItali            term=none  cterm=none  gui=none
      hi def htmlBoldUnderlineItali   term=none  cterm=none  gui=none
      hi def htmlUnderlin             term=none  cterm=none  gui=none
      hi def htmlUnderlineItali       term=none  cterm=none  gui=none
      hi def htmlItali                term=none  cterm=none  gui=none
    endif
  endif
