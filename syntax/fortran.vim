...
"
"  Changes by Michael Goerz:
"  * Format pre-compiler directives as comments
"  * Format QDYN docstrings (!!) as strings instead of comments, for emphasis
...
"QDYN docstrings
syn match	fortranDocString	"^\s*!!.*" contains=@fortranCommentGroup,@spell
...
hi def link fortranDocString	String
...
hi def link cPreProc		Comment
hi def link cPreCondit		Comment
